...
- 感情ラベル: {pkg['qualia']['emotion_label']}
    ...
    def think(self, world: World) -> Tuple[str, Dict]:
        ...
        if balls and not self.l1.holding:
            ...
            for color, info in balls.items():
                ...
                total = pref + dist_penalty + danger_penalty + safe_bonus + energy_penalty
                scores[color] = total
                details[color] = {
                    'preference': pref,
    ...
    def _check_danger_damage(self, world: World):
        ...
        if world.get_cell(x, y) == 'danger':
            ...
            if random.random() < 0.33:
                ...
                print(f"    ⚡ 痛い！ fear={self.l2.qualia['fear']:.2f}")
            ...
            if random.random() < 0.33:
                ...
                print(f"    💦 疲れた！ E={self.l1.energy:.2f}")
